...
![header](https://capsule-render.vercel.app/api?type=waving&color=0:F5A524,50:A78BFA,100:2DD4BF&height=190&section=header&text=Reetu%20Thimmaiah&fontSize=58&fontColor=FFFFFF&animation=fadeIn&fontAlignY=32&desc=Data%20Engineer%20%C2%B7%20Batch%20%26%20Streaming%20Platforms%20%C2%B7%20AI-Ready%20Pipelines&descSize=17&descAlignY=52)
...
[![Real-Time Inventory Lakehouse](assets/realtime-inventory-lakehouse.svg)](https://github.com/reetu95/realtime-inventory-lakehouse)

**[Real-Time Inventory Lakehouse](https://github.com/reetu95/realtime-inventory-lakehouse)** · *featured, in progress* — exactly-once streaming Medallion pipeline; quarantine-driven DQ caught a silent NULL bug dropping 20% of events
...
**[AI-Powered Financial Document Analysis](https://github.com/reetu95/AI-Powered-Financial-Document-Analysis)** — agentic RAG, iterated V1→V3 to more than double GPT-4 Turbo's FinanceBench baseline

<br>

![AI Medical Report Analysis](assets/medical-report-analysis.svg)

**AI Medical Report Analysis** · *accepted as conference abstract* — Graph RAG that reads heart-scan PDFs and classifies clinical severity

<br>

[![Enterprise RAG Service](assets/enterprise-rag-service.svg)](https://github.com/reetu95/enterprise-rag-service)

**[Enterprise RAG Service](https://github.com/reetu95/enterprise-rag-service)** — production retrieval pipeline with async ingestion and OCR fallback

<br>

### 📊 Data Science & ML

[![Real-Time Dynamic Pricing Engine](assets/dynamic-pricing-engine.svg)](https://github.com/reetu95/AutopricingNew)

**[Real-Time Dynamic Pricing Engine](https://github.com/reetu95/AutopricingNew)** — LightGBM on an AWS MLOps stack; pricing turnaround cut from 30 minutes to under 5 seconds

<br>

[![AWS CI/CD ML Pipeline](assets/aws-cicd-ml-pipeline.svg)](https://github.com/reetu95/AWS-CI-CD-Proejct)

**[AWS CI/CD ML Pipeline](https://github.com/reetu95/AWS-CI-CD-Proejct)** — automated build, test, and release for ML deployment
