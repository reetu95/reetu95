<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:F5A524,50:A78BFA,100:2DD4BF&height=190&section=header&text=Reetu%20Thimmaiah&fontSize=58&fontColor=FFFFFF&fontAlignY=32&desc=Data%20Science%20%
  C2%B7%20Machine%20Learning%20%C2%B7%20Applied%20AI&descSize=17&descAlignY=52" alt="Reetu Thimmaiah — Data Science, Machine Learning, Applied AI" />
  ...
  <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=500&size=20&pause=1200&color=A78BFA&center=true&vCenter=true&width=850&lines=Start+with+the+decision%2C+then+the+model;Surrogate+Models%2C+U
  plift+%26+Forecasting;Agentic+RAG%2C+LLM+Fine-Tuning+%26+Evaluation;7+years+turning+data+into+decisions" alt="typing" />
  ...
  I start from the question — what decision needs to be made, what data can realistically answer it, and whether solving it creates enough value — then build the model and the pipeline that keeps it working.

  Over 7 years across manufacturing, supply chain, retail pricing, and ecommerce, I've built demand forecasting for 6,500+ SKUs across five plants and deployed a pricing model behind a REST API that cut turnaround
  from 30 minutes to 5 seconds, both with automated retraining and monitoring.
  ...
  **[ML Surrogate for Heat Sink Cooling](https://github.com/reetu95/cfd-ml-surrogate-heatsink)** &nbsp; <img src="https://img.shields.io/badge/Featured-A78BFA?style=flat-square" /> <img 
  ...
  the whole temperature field in **40 ms — a 22,500× speedup** — at **MAE 0.021 K** and **R² 0.999997** on 383,138 held-out points. Accepted to ASME FEDSM 2026.
  ...
  **[Churn Without a Cancel Button](https://github.com/reetu95/Customer-Retention-Segmentation-Uplift)** &nbsp; <img src="https://img.shields.io/badge/Live%20app-F5A524?style=flat-square" />
  ...
  finding is that the ranking flips depending on what you count: at a 5% budget, targeting by likely response returns **147** extra purchases per 1,000 customers against **32** for targeting by churn risk — but
  the keenest responders spend the least, so weighting response by value gives **₽1.24M** incremental revenue against **₽0.27M**. Neither "who is leaving" nor "who responds" is enough alone.
  ...
  **[PriceWise — C2B Vehicle Pricing](https://github.com/reetu95/AutopricingNew)**
  ...
  and logs whether each recommendation was accepted, rejected, or **overridden** — closing the loop between the model and the humans using it.
  ...
  **Cloud & DevOps**
  ...
  📫 Open to **Data Scientist** roles &nbsp;·&nbsp; <a href="mailto:reetu.thimmaiah@gmail.com">reetu.thimmaiah@gmail.com</a>
